...
import Mapwa_1 from "../../Assets/Projects/Mapwa_1.png";
import Mapwa_2 from "../../Assets/Projects/Mapwa_2.png";
import Mapwa_3 from "../../Assets/Projects/Mapwa_3.png";
import Mapwa_4 from "../../Assets/Projects/Mapwa_4.png";
import Mapwa_5 from "../../Assets/Projects/Mapwa_5.png";
import Mapwa_6 from "../../Assets/Projects/Mapwa_6.png";
    ...
    <Container fluid className="project-section">
      ...
      <Container>
        ...
        <Col md={4} className="project-card">
            <ProjectCard
              imgPath={zara}
              imgPaths={[Mapwa_1, Mapwa_2, Mapwa_3, Mapwa_4,Mapwa_5,Mapwa_6]}
              isBlog={false}
              title="MA-LIS Practicum Web App"
              description="Developed a web application to enhance the practicum experience for MA-LIS program students and partner sites. Utilized Node.js to create a RESTful API for efficient data management, including inserting, deleting, and fetching records. Designed user-friendly frontend components with HTML, CSS, and JavaScript to improve user interaction and overall experience, fostering better communication between students and partner sites."
            />
          </Col>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
             imgPath={zara}
              ...
              description="I led the development of a Planner configurations service, utilizing Java and ReactJs, to optimize the configuration process for admin users. This initiative drove a remarkable 40% enhancement in customization capabilities within supply chain software systems. By leveraging both backend Java expertise and frontend ReactJs proficiency, I successfully delivered a comprehensive solution that streamlined operations and maximized system flexibility."
